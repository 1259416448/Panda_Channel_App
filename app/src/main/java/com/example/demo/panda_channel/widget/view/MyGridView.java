...
//                mVibrator.vibrate(50);//设置震动时间
                ...
                if (dragView == null) {
                    dragView = View.inflate(getContext(), R.layout.gildview_item, null);
                    TextView tv_text = (TextView) dragView.findViewById(R.id.gridview_text);
                    tv_text.setText(((TextView) view.findViewById(R.id.gridview_text)).getText());
                } else {
                    TextView tv_text = (TextView) dragView.findViewById(R.id.gridview_text);
                    tv_text.setText(((TextView) dragView.findViewById(R.id.gridview_text)).getText());
                }
                windowLayoutParams = new WindowManager.LayoutParams();
                windowLayoutParams.gravity = Gravity.TOP | Gravity.LEFT;
                windowLayoutParams.width = 260;
                windowLayoutParams.height = 100;
    ...
    private void closeWindow(MotionEvent ev) {
        ...
        ((GildViewAdapter) getAdapter()).notifyDataSetChanged();
    }
    ...
    private void updateWindow(MotionEvent ev, int deltaX, int deltaY) {
        ...
        if (mTempPos != AdapterView.INVALID_POSITION && mTempPos != prePos) {
            ...
            ((GildViewAdapter) getAdapter()).swap(prePos, mTempPos);
            prePos = mTempPos;
        }
